...
enum class NodeType
{
    ...
    REPEAT_STATEMENT, CASE_LABEL, CONSTANT, UNSIGNED_NUMBER, UNSIGNED_REAL, SIGN, CONSTANT_IDENTIFIER,
    FOR_STATEMENT, CONTROL_VARIABLE, FOR_LIST, INITIAL_VALUE, FINAL_VALUE
};
